                ...
                <aside className="hidden lg:flex w-72 flex-col bg-[hsl(var(--sidebar-background))] text-[hsl(var(--sidebar-foreground))] shadow-2xl">
                    <div className="p-6 border-b border-sidebar-border">
                        <Link href="/" className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-2xlr flex items-center justify-center shadow-lg shadow-[#D95F5F]/20">
                    ...
                    <div className="p-4 space-y-2 flex-1">
                        ...
                        {navItems.map(({ label, href, active, icon: Icon }) => (
                            ...
                            >
                                <span className={`w-10 h-10 rounded-xl flex items-center justify-center ${active ? 'bg-[#EFF4F8] text-[#D95F5F] dark:bg-white/20 dark:text-white' : 'bg-white/10 text-[#D8E4ED]'}`}>
                    ...
                    <div className="p-4 border-t border-sidebar-border">
                        <div className="rounded-3xl bg-white/10 border border-sidebar-border p-4 mb-3">
                            <div className="flex items-center gap-3">
                                <div className="w-11 h-11 rounded-2xl bg-[#27527A] flex items-center justify-center"><UserCircle className="w-6 h-6" /></div>
