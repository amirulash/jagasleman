        ...
        <div className="min-h-screen overflow-hidden bg-slate-50 relative flex items-center justify-center px-4 py-10">
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="mb-6 flex justify-center">
                    <Link href="/" className="group flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white/75 px-4 py-3 shadow-lg shadow-slate-900/5 backdrop-blur-xl transition hover:-translate-y-0.5 hover:shadow-[#F47B52]/10">
                        <div className="flex h-11 w-11 items-center justify-center rounded-xlr text-white shadow-lg shadow-[#F47B52]/25">
