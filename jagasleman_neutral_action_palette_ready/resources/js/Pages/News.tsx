...
function getCategoryClass(category: GeneralCategory) {
    ...
    return 'border-[#D8E4ED] bg-[#EFF4F8] text-[#1A3348]';
}
...
export default function News() {
    ...
    return (
        <div className="min-h-full bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 px-4 py-6 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl space-y-6">
                <section className="overflow-hidden rounded-[2rem] bg-slate-950 text-white shadow-xl">
                    <div className="relative p-6 sm:p-8 lg:p-10">
                        <div className="absolute right-0 top-0 h-72 w-72 rounded-full bg-[#27527A]/20 blur-3xl" />
                        <div className="absolute bottom-0 left-1/3 h-56 w-56 rounded-full bg-[#D95F5F]/10 blur-3xl" />

                        <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
                            <div>
                                <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-white backdrop-blur">
                                    <Newspaper className="h-4 w-4" />
                                    Info Kamtibmas Sleman
                                </div>

                                <h1 className="max-w-3xl text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">
                                    Berita terbaru yang ringkas, jelas, dan mudah ditelusuri.
                                </h1>

                                <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                                    Pantau kabar keamanan, kejahatan, himbauan, dan ketertiban umum dalam tampilan yang lebih ringan.
                                </p>
                                ...
                                <div className="mt-6 grid max-w-2xl grid-cols-3 gap-3">
                                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 text-white backdrop-blur">
                                        <p className="text-2xl font-black">{sortedNews.length}</p>
                                        <p className="mt-1 text-xs font-bold text-white/75">Berita</p>
                                    </div>

                                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 text-white backdrop-blur">
                                        <p className="text-2xl font-black">{NEWS_CATEGORIES.length - 1}</p>
                                        <p className="mt-1 text-xs font-bold text-white/75">Kategori</p>
                                    </div>

                                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 text-white backdrop-blur">
                                        <p className="text-2xl font-black">{latestDate}</p>
                                        <p className="mt-1 text-xs font-bold text-white/75">Update</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {featuredNews && (
                                ...
                                >
                                    <div className="rounded-[1.7rem] border border-white/15 bg-white p-5 text-[#0F1F2E] shadow-2xl shadow-black/10 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-2xl">
                                        <div className="mb-4 flex items-center justify-between gap-3">
                                            <span className="inline-flex items-center gap-2 rounded-full bg-[#D95F5F] px-3 py-1 text-xs font-black text-white">
                                                <Sparkles className="h-3.5 w-3.5" />
                                                Sorotan Utama
                                            </span>

                                            <span className="rounded-full bg-[#EFF4F8] px-3 py-1 text-xs font-bold text-[#27527A]">
                                                {formatTanggalPendek(featuredNews.date)}
                                            </span>
                                        </div>

                                        <h2
                                            className="text-xl font-black leading-snug text-[#0F1F2E] transition group-hover:text-[#D95F5F]"
                                            style={clampStyle(3)}
                                        >
                                            {featuredNews.title}
                                        </h2>
                                        ...
                                        <p
                                            className="mt-3 text-sm leading-6 text-[#35506D]"
                                            style={clampStyle(2)}
                                        >
                                            {featuredNews.excerpt}
                                        </p>

                                        <div className="mt-5 inline-flex items-center gap-2 text-sm font-black text-[#D95F5F]">
                                            Lihat ringkasan
                ...
                <section className="rounded-[1.8rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-4 shadow-sm sm:p-5">
                    <div className="grid gap-4 lg:grid-cols-[1fr_220px]">
                        <label className="relative block">
                            ...
                            <input
                                ...
                                className="h-12 w-full rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 pl-11 pr-4 text-sm font-semibold text-slate-800 dark:text-white outline-none transition placeholder:text-slate-500 dark:text-slate-300 dark:text-slate-300 focus:border-[#27527A] focus:bg-white dark:bg-[#102538] dark:bg-[#1A3348] focus:ring-4 focus:ring-[#D8E4ED]/35"
                            />
                        </label>
                        ...
                        <select
                            ...
                            className="h-12 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 px-4 text-sm font-black text-slate-700 dark:text-slate-100 outline-none transition focus:border-[#27527A] focus:bg-white dark:bg-[#102538] dark:bg-[#1A3348] focus:ring-4 focus:ring-[#D8E4ED]/35"
                        >
                            {years.map((item) => (
                                ...
                                <button
                                    ...
                                    className={`shrink-0 rounded-full border px-4 py-2 text-xs font-black transition ${
                                        active
                                            ...
                                            : 'border-slate-200 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] text-slate-600 dark:text-slate-200 hover:border-[#D8E4ED] hover:bg-[#EFF4F8] hover:text-[#D95F5F]'
                                    }`}
                                >
                ...
                <section className="grid gap-6 lg:grid-cols-[1fr_330px]">
                    <main className="space-y-6">
                                ...
                                {quickHighlights.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="group rounded-[1.5rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-5 text-left shadow-sm transition hover:-translate-y-1 hover:border-[#D8E4ED] hover:shadow-md"
                                        >
                                            ...
                                            <h3
                                                className="text-base font-black leading-snug text-foreground transition group-hover:text-[#D95F5F]"
                                                style={clampStyle(3)}
                                            >
                                                {item.title}
                                            </h3>
                        ...
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-600 dark:text-slate-200 dark:text-slate-300">
                                    {filteredNews.length} berita ditemukan. Pilih kartu untuk melihat ringkasan cepat.
                                </p>
                            </div>

                            <div className="rounded-full bg-white dark:bg-[#102538] dark:bg-[#1A3348] px-4 py-2 text-xs font-black text-slate-600 dark:text-slate-200 dark:text-slate-300 shadow-sm ring-1 ring-slate-100">
                        ...
                        {visibleNews.length > 0 ? (
                            <div className="grid gap-4 md:grid-cols-2">
                                {visibleNews.map((item) => {
                                    ...
                                    return (
                                        <article
                                            key={item.id}
                                            className="group overflow-hidden rounded-[1.7rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] shadow-sm transition hover:-translate-y-1 hover:border-[#D8E4ED] hover:shadow-md"
                                        >
                                            <div className="h-2" />
                                            ...
                                            <div className="p-5">
                                                ...
                                                <h3
                                                    className="text-lg font-black leading-snug text-foreground transition group-hover:text-[#D95F5F]"
                                                    style={clampStyle(2)}
                                                >
                                                    {item.title}
                                                </h3>
                                                ...
                                                <div className="mt-4 grid gap-2 text-xs font-bold text-slate-600 dark:text-slate-200 dark:text-slate-300">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <FileText className="h-4 w-4 text-[#D95F5F]" />
                                                ...
                                                <div className="mt-5 flex gap-2">
                                                    <button
                                                        type="button"
                                                        onClick={() => setSelectedNews(item)}
                                                        className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-slate-900 px-4 py-2.5 text-sm font-black text-white transition hover:bg-[#1A3348]"
                                                    >
                                                        Ringkasan
                                                        <Eye className="h-4 w-4" />
                                                    </button>
                                                    ...
                                                    {isValidUrl(item.url) && (
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="inline-flex items-center justify-center rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] px-4 py-2.5 text-sm font-black text-slate-700 dark:text-slate-100 transition hover:border-[#D8E4ED] hover:bg-[#EFF4F8] hover:text-[#D95F5F]"
                            ...
                            <div className="rounded-[1.7rem] border border-dashed border-slate-300 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-10 text-center">
                                ...
                                <button
                                    type="button"
                                    onClick={resetFilter}
                                    className="mt-5 rounded-2xl bg-[#1A3348] px-5 py-3 text-sm font-black text-white transition hover:bg-[#1A3348]"
                                >
                                    Reset Filter
                                </button>
                            </div>
                        ...
                        {filteredNews.length > ITEMS_PER_PAGE && (
                            <div className="flex flex-col gap-3 rounded-[1.7rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
                                <button
                                    type="button"
                                    disabled={page === 1}
                                    onClick={() => setPage((prev) => Math.max(1, prev - 1))}
                                    className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] px-4 py-3 text-sm font-black text-slate-700 dark:text-slate-100 transition hover:bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 disabled:cursor-not-allowed disabled:opacity-40"
                                >
                                            ...
                                            <button
                                                ...
                                                className={`h-10 w-10 rounded-xl text-sm font-black transition ${
                                                    active
                                                        ...
                                                        : 'bg-slate-100 dark:bg-[#17324A] text-slate-600 dark:text-slate-200 hover:bg-[#EFF4F8] hover:text-[#D95F5F]'
                                                }`}
                                            >
                                                {currentPage}
                                            </button>
                    ...
                    <aside className="space-y-4 lg:sticky lg:top-6 lg:self-start">
                        <div className="rounded-[1.7rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-5 shadow-sm">
                            <div className="mb-4 flex items-center gap-2">
                                <Tag className="h-5 w-5 text-[#D95F5F]" />
                                        ...
                                        <button
                                            ...
                                            className={`flex w-full items-center justify-between rounded-2xl px-4 py-3 text-left transition ${
                                                category === categoryName
                                                    ? 'bg-[#1A3348] text-white'
                                                    : 'bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 text-slate-600 dark:text-slate-200 hover:bg-[#EFF4F8] hover:text-[#D95F5F]'
                                            }`}
                                        >
                                            <span>
                        ...
                        <div className="rounded-[1.7rem] border border-slate-100 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] p-5 shadow-sm">
                            <div className="mb-4 flex items-center gap-2">
                                <CalendarDays className="h-5 w-5 text-[#D95F5F]" />
                                        ...
                                        <button
                                            ...
                                            className={`rounded-2xl px-4 py-3 text-left transition ${
                                                year === name
                                                    ...
                                                    : 'bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 text-slate-600 dark:text-slate-200 hover:bg-slate-100 dark:bg-[#17324A]'
                                            }`}
                                        >
                        ...
                        <div className="rounded-[1.7rem] border border-[#D8E4ED] bg-white p-5 shadow-sm dark:bg-[#102538]">
                            <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-[#1A3348] text-white">
                                <Sparkles className="h-5 w-5" />
                            </div>

                            <h3 className="font-black text-[#0F1F2E] dark:text-white">Mode Baca Cepat</h3>
                            <p className="mt-2 text-sm leading-6 text-[#1A3348] dark:text-slate-200">
                                Klik kartu berita untuk melihat ringkasan singkat tanpa membuka tab baru.
                            </p>
                        </div>
                    </aside>
                </section>
            ...
            {selectedNews && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 px-4 py-6 backdrop-blur-sm">
                    <div className="w-full max-w-2xl overflow-hidden rounded-[2rem] bg-white dark:bg-[#102538] dark:bg-[#1A3348] shadow-2xl">
                        ...
                        <div className="p-5 sm:p-6">
                            <div className="mb-5 grid gap-3 sm:grid-cols-3">
                                <div className="rounded-2xl bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70 p-4">
                            ...
                            <div className="mt-5 flex items-center gap-2 rounded-2xl bg-[#EFF4F8] p-4 text-sm font-bold text-[#1A3348]">
                            ...
                            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                                <button
                                    type="button"
                                    onClick={() => setSelectedNews(null)}
                                    className="inline-flex flex-1 items-center justify-center rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#102538] dark:bg-[#1A3348] px-5 py-3 text-sm font-black text-slate-700 dark:text-slate-100 transition hover:bg-slate-50 dark:bg-[#17324A] dark:bg-[#0F1F2E]/70"
                                >
                                    Tutup
                                </button>
                                ...
                                {isValidUrl(selectedNews.url) && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#1A3348] px-5 py-3 text-sm font-black text-white transition hover:bg-[#1A3348]"
                                    >
                                        Buka Sumber
                                        <ArrowUpRight className="h-4 w-4" />
                                    </a>
