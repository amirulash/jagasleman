...
export default function LiveStatusBar() {
  ...
  const statusColor = isRawan ? "#F47B52" : isSore ? "#F2A20B" : "#4ade80";
  ...
  return (
    ...
    >
      ...
      {/* Kejadian hari ini */}
      <div className="flex items-center gap-1.5 flex-shrink-0">
        <AlertTriangle className="w-3 h-3" style={{ color: "#F2A20B", opacity: 0.8 }} />
        <span>
          <span style={{ color: "#F2A20B", fontWeight: 500 }}>{todayCount}</span>
          {" "}kejadian hari ini
        </span>
      </div>
